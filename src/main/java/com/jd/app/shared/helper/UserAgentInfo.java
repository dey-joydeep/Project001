...
public class UserAgentInfo {
	// UserEntity-Agent and Accept HTTP request headers
	...
	public static final String engineNetfront = "netfront"; // CommonEntity embedded
															// OS browser
	...
	public boolean detectMobileLong() {
		...
		if (detectDangerHiptop() || detectMaemoTablet() || detectSonyMylo()
				|| detectArchos()) {
			return true;
		}
	...
	public boolean detectTierTablet() {
		if (detectIpad() || detectAndroidTablet() || detectBlackBerryTablet()
				|| detectFirefoxOSTablet() || detectUbuntuTablet()
				|| detectWebOSTablet()) {
			return true;
		}
		return false;
	...
	public boolean detectTierIphone() {
		if (detectIphoneOrIpod() || detectAndroidPhone()
				...
				|| detectFirefoxOSPhone() || detectSailfishPhone()
				|| detectUbuntuPhone() || detectGamingHandheld()) {
			return true;
		}
		return false;
	}
